...
def getLoader(datasetName, dataroot, originalSize, imageSize, batchSize=64, workers=4,
  ...
  if datasetName == 'outdoordataset':
    from outdoordataset import pix2pix as commonDataset
    import transform as transforms
  elif datasetName == 'indoordataset':
    from indoordataset import pix2pix as commonDataset
    import transform as transforms
